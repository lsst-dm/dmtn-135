...
A high level bottom line is given in \tabref{tab:summary}. The remainder of the document is all the details that went into that.
...
\tabref{tab:StorageCost} gives the price of storage using all 3 types that we need. i
