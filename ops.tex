...
Note that in \tabref{tab:opsChileR} the storage is  big enough for Raws  and LSSTCam Coadds plus a small margin. It also does not include a Qserv. See also \tabref{tab:opsSumChile}
\input{opsChileR}
